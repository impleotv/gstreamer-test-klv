...
const char* PathToLibrary = "/home/alexc/Work/gstreamer_klv/misbCoreNative/NativeLibrary.so";
...
auto jspnPckt =  json::parse(R"(
    ...
    //buffer = gst_buffer_new_allocate(NULL, sizeof(klv_metadata), NULL);
   ...
   // gst_buffer_fill(buffer, 0, klv_metadata, sizeof(klv_metadata));
   
    gst_buffer_fill(buffer, 0, buf, sizeof(klv_metadata));
